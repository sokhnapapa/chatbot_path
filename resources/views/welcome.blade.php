...
<head>
    ...
    <title>PATH Uganda HIVST Chatbot</title>
    ...
    <style>
        body {
            ...
            background: radial-gradient(#ffffff, #CACFD2);
        }
...
<div class="fb-customerchat"
     ...
     page_id="538139916586328"
     theme_color="#d696bb">
</div>
<div class="container">
    <div class="content">
        <div class="logo__" style="width: 100%;text-align: center">
            <img src="{{asset('images/PATH-logo.png')}}" width="500" height="250">
        ...
        <div class="links">
            ...
            <a href="https://www.path.org/" target="_blank">Website</a>
        </div>
    </div>
</div>
</body>
...
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/botman-web-widget@0/build/assets/css/chat.min.css">
    <script>
        var botmanWidget = {
            aboutText: 'ssdsd',
            introMessage: "✋ Hi! I'm here to help you find info about HIV kits. Type 'hey' to get started."
        };
    </script>
